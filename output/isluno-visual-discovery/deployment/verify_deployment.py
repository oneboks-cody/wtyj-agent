...
print(json.dumps({'status':'live_verified','source':EXPECTED['source'],'image':mm['Image'],'container_id':mm['Id'],'health':200,'runtime_generation':14,'ingress_generation':13,'catalog_products':31,'source_files_verified':len(HASHES),'dashboard_pointer_verified':True,'producers_restored':True,'agent_messages_sent':0,'retained_history_proof':proof['sha256'],'catalog_sha256':EXPECTED['catalog_sha256']}))
'''
