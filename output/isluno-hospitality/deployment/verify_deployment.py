...
print(json.dumps({'status':'live_verified','source':EXPECTED['source'],'image':mm['Image'],'container_id':mm['Id'],'health':200,'runtime_generation':8,'ingress_generation':7,'catalog_products':31,'source_files_verified':len(HASHES),'dashboard_unchanged':True,'producers_restored':True,'agent_messages_sent':0}))
'''
