...
def event(phase,**extra):
 ...
 p=ROOT/'recovery-e-progress.json';p.write_text(json.dumps({'events':EVENTS,'state':STATE},sort_keys=True));p.chmod(0o600)
...
def execute():
 ...
 require(digest(ROOT/'state_registry.recovery-d.sqlite3')=='269a45bead0fd1dc85ab651bc256202db3e3dc6c52653195dce4d431741cd349','consumed_d_snapshot')
 require(digest(ROOT/'tools/wtyj/scripts/recover_isluno_staged_cutover.py')=='c8d10d28f6f01d3b90571e03240cbee217d0c5e08734390297b9c95ce506f606','consumed_d_helper')
 ...
 fd=os.open(ROOT/'recovery-e-dispatch.json',os.O_WRONLY|os.O_CREAT|os.O_EXCL,0o600)
 ...
 target=ROOT/'tools/wtyj/scripts/recover_isluno_staged_cutover_e.py'
 ...
 sealed=one_shot('recover_isluno_staged_cutover_e.py',['--execute-approved-recovery-e','--approve-preserved-unresolved-quarantine-71','--expected-config-sha256',STAGED_CONFIG_SHA,'--expected-db-bundle-sha256',bundle,'--verified-quiescence-reference','calvin-isluno-recovery-e'],50)
