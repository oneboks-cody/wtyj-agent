...
LABELS = {
    "en": {
    "title": "Your Klein Curaçao quote",
    "quote": "Quote",
    "customer": "Guest",
    "date": "Date",
    "guests": "Guests",
    ...
    "schedule": "Your day",
    "bring": "What to bring",
    "rules": "Practical information and conditions",
    "payment": "Next step",
    "payment_text": "Use the payment link sent in WhatsApp to complete your booking.",
    "arrival": "Please arrive at Fishermen's Pier at 06:45. Departure from the island is scheduled for approximately 15:20.",
    "pickup": "Hotel pickup requested; location and price require confirmation.",
    "pier": "Meet at Fishermen's Pier",
    "valid": "This quote is valid for 60 minutes.",
    "available": ""
},
    "nl": {
    ...
    "de": {
    "title": "Ihr Angebot für Klein Curaçao",
    "quote": "Angebot",
    "customer": "Gast",
    "date": "Datum",
    "guests": "Gäste",
    "transport": "Transport",
    "charges": "Preisübersicht",
    ...
    "rules": "Praktische Hinweise und Bedingungen",
    "payment": "Nächster Schritt",
    "payment_text": "Schließen Sie Ihre Buchung über den Zahlungslink in WhatsApp ab.",
    "arrival": "Bitte seien Sie um 06:45 am Fishermen's Pier. Die Abfahrt von der Insel ist gegen 15:20 geplant.",
    "pickup": "Hotelabholung angefragt; Ort und Preis müssen bestätigt werden.",
    "pier": "Treffpunkt Fishermen's Pier",
    "valid": "Dieses Angebot ist 60 Minuten gültig.",
    "available": ""
},
    "es": {
    "title": "Su cotización para Klein Curaçao",
    "quote": "Cotización",
    "customer": "Pasajero",
    "date": "Fecha",
    "guests": "Pasajeros",
    "transport": "Transporte",
    "charges": "Detalle del precio",
    ...
    "schedule": "Su día",
    "bring": "Qué llevar",
    "rules": "Información práctica y condiciones",
    "payment": "Siguiente paso",
    "payment_text": "Complete su reserva con el enlace de pago enviado por WhatsApp.",
    "arrival": "Le esperamos en Fishermen's Pier a las 06:45. La salida de la isla está prevista para las 15:20 aproximadamente.",
    "pickup": "Recogida en hotel solicitada; ubicación y precio requieren confirmación.",
    "pier": "Encuentro en Fishermen's Pier",
    "valid": "Esta cotización es válida por 60 minutos.",
    "available": ""
},
    "pap": {
    "title": "Bo oferta pa Klein Curaçao",
    "quote": "Oferta",
    "customer": "Bishitante",
    "date": "Fecha",
    "guests": "Bishitantenan",
    "transport": "Transporte",
    "charges": "Detaye di preis",
    "description": "Deskripshon",
    "qty": "Kant.",
    "unit": "Preis pa un",
    "amount": "Montante",
    "total": "Total",
    "included": "Loke ta inkluí",
    "schedule": "Bo dia",
    "bring": "Hiba ku bo",
    "rules": "Informashon práktiko i kondishonnan",
    "payment": "Siguiente paso",
    "payment_text": "Kompletá bo reservashon ku e link di pago mandá den WhatsApp.",
    "arrival": "Por fabor, yega na Fishermen's Pier pa 06:45. E salida for di e isla ta planifiká pa mas o ménos 15:20.",
    "pickup": "E servisio pa buska bo na bo alohamentu ta pidi; lugá i preis mester wòrdu konfirmá.",
    "pier": "Topa na Fishermen's Pier",
    "valid": "E oferta aki ta válido pa 60 minüt.",
    "available": ""
},
    "pt": {
    "title": "Sua cotação para Klein Curaçao",
    "quote": "Cotação",
    "customer": "Passageiro",
    "date": "Data",
    "guests": "Passageiros",
    "transport": "Transporte",
    "charges": "Detalhamento do valor",
    ...
    "schedule": "Seu dia",
    "bring": "O que levar",
    "rules": "Informações práticas e condições",
    "payment": "Próximo passo",
    "payment_text": "Conclua sua reserva pelo link de pagamento enviado no WhatsApp.",
    "arrival": "Pedimos que chegue ao Fishermen's Pier às 06:45. A saída da ilha está prevista para aproximadamente 15:20.",
    "pickup": "Traslado do hotel solicitado; local e preço exigem confirmação.",
    "pier": "Encontro no Fishermen's Pier",
    "valid": "Esta cotação é válida por 60 minutos.",
    "available": ""
},
}
...
DOCUMENT_COPY = {
    "en": {
    "tagline": "A day on Klein Curaçao",
    "party": "{adults} adults, {children} children 4-12, {infants} children 0-3",
    "catalog": "Catalog",
    "items": {
        "adult": "Adult",
        "child_4_12": "Child (4–12 years)",
        "infant_0_3": "Child (0–3 years)"
    },
    "included_items": [
        "Breakfast and barbecue lunch",
        "Soft drinks and fruit juices",
        "Snorkeling masks and beach chairs",
        "Beach house with restrooms and a fresh-water shower"
    ],
    "bring_items": [
        "Towel",
        "Sunscreen",
    ...
    "protocol_title": "Good to know",
    "protocol": "Follow the captain’s and crew’s instructions and supervise children. Use safety equipment as directed. Let us know about dietary needs or assistance you require before your visit. Crossing times depend on sea conditions, and sea turtle sightings cannot be guaranteed. Beer and wine cost extra; fins are not provided.",
    "closing": "We look forward to welcoming you aboard.",
    "receipt_title": "Payment receipt",
    "booking_code": "Booking code",
    "payment_reference": "Payment reference",
    "payment_time": "Payment time (UTC)",
    "receipt_disclaimer": "",
    "receipt_arrival": "Please arrive at Fishermen's Pier at 06:45. We look forward to welcoming you aboard.",
    "items_plural": {
        "adult": "Adults",
        "child_4_12": "Children (4–12 years)",
        "infant_0_3": "Children (0–3 years)"
    }
},
    "nl": {
    ...
    "de": {
    "tagline": "Ein Tag auf Klein Curaçao",
    "party": "{adults} Erwachsene, {children} Kinder 4-12, {infants} Kinder 0-3",
    "catalog": "Katalog",
    "items": {
        "adult": "Erwachsener",
        "child_4_12": "Kind (4–12 Jahre)",
        "infant_0_3": "Kind (0–3 Jahre)"
    },
    "included_items": [
        "Frühstück und Mittagessen vom Grill",
        "Erfrischungsgetränke und Fruchtsäfte",
        "Schnorchelmasken und Strandstühle",
        "Strandhaus mit Toiletten und Süßwasserdusche"
    ],
    "bring_items": [
        "Handtuch",
        "Sonnencreme",
    ...
    "protocol_title": "Gut zu wissen",
    "protocol": "Folgen Sie den Anweisungen des Kapitäns und der Crew und behalten Sie Kinder im Blick. Benutzen Sie die Sicherheitsausrüstung wie angewiesen. Teilen Sie uns Ernährungsbedürfnisse oder benötigte Unterstützung vorab mit. Die Überfahrt hängt von den Seebedingungen ab; Meeresschildkröten sind nicht immer zu sehen. Bier und Wein kosten extra. Schwimmflossen werden nicht bereitgestellt.",
    "closing": "Wir freuen uns darauf, Sie an Bord zu begrüßen.",
    "receipt_title": "Zahlungsbeleg",
    "booking_code": "Buchungscode",
    "payment_reference": "Zahlungsreferenz",
    "payment_time": "Zahlungszeit (UTC)",
    "receipt_disclaimer": "",
    "receipt_arrival": "Bitte seien Sie um 06:45 am Fishermen's Pier. Wir freuen uns darauf, Sie an Bord zu begrüßen.",
    "items_plural": {
        "adult": "Erwachsene",
        "child_4_12": "Kinder (4–12 Jahre)",
        "infant_0_3": "Kinder (0–3 Jahre)"
    }
},
    "es": {
    "tagline": "Un día en Klein Curaçao",
    "party": "{adults} adultos, {children} niños de 4-12, {infants} niños de 0-3",
    "catalog": "Catálogo",
    "items": {
        "adult": "Adulto",
        "child_4_12": "Niño (4–12 años)",
        "infant_0_3": "Niño (0–3 años)"
    },
    "included_items": [
        "Desayuno y almuerzo a la parrilla",
        "Refrescos y jugos de fruta",
        "Máscaras de snorkel y sillas de playa",
        "Casa de playa con baños y ducha de agua dulce"
    ],
    "bring_items": [
        "Toalla",
        "Protector solar",
    ...
    "protocol_title": "Tenga en cuenta",
    "protocol": "Siga las indicaciones del capitán y la tripulación y supervise a los niños. Utilice el equipo de seguridad según las instrucciones. Avísenos con antelación si tiene necesidades alimentarias o requiere asistencia. La travesía depende del estado del mar; no se garantiza ver tortugas marinas. La cerveza y el vino tienen un costo adicional. No se proporcionan aletas.",
    "closing": "Será un placer darle la bienvenida a bordo.",
    "receipt_title": "Recibo de pago",
    "booking_code": "Código de reserva",
    "payment_reference": "Referencia de pago",
    "payment_time": "Hora del pago (UTC)",
    "receipt_disclaimer": "",
    "receipt_arrival": "Le esperamos en Fishermen's Pier a las 06:45. Será un placer darle la bienvenida a bordo.",
    "items_plural": {
        "adult": "Adultos",
        "child_4_12": "Niños (4–12 años)",
        "infant_0_3": "Niños (0–3 años)"
    }
},
    "pap": {
    "tagline": "Un dia na Klein Curaçao",
    "party": "{adults} adulto, {children} mucha di 4-12, {infants} mucha di 0-3",
    "catalog": "Katalòk",
    "items": {
        "adult": "Adulto",
        "child_4_12": "Mucha (4–12 aña)",
        "infant_0_3": "Mucha (0–3 aña)"
    },
    "included_items": [
        "Desayuno i almuerso di barbekiú",
        "Refresko i djus di fruta",
        "Máskara di snòrkel i stul di playa",
        "Kas di playa ku baño i ducha di awa dushi"
    ],
    "bring_items": [
        "Toaya",
        "Krema solar",
    ...
    "protocol_title": "Bon pa sa",
    "protocol": "Sigui e instrukshonnan di e kapitan i tripulashon i tene bista riba e muchanan. Usa e ekiponan di siguridat manera indiká. Bisa nos di antemano si bo tin nesesidat di dieta òf mester asistensia. E biahe ta dependé di e kondishonnan di laman; nos no por garantisá ku bo lo mira turtuga. Serbes i biña ta kosta èkstra. Nos no ta suministrá flèper.",
    "closing": "Nos ta spera bo ku hopi gusto na bordo.",
    "receipt_title": "Resibu di pago",
    "booking_code": "Kódigo di reservashon",
    "payment_reference": "Referensia di pago",
    "payment_time": "Ora di pago (UTC)",
    "receipt_disclaimer": "",
    "receipt_arrival": "Por fabor, yega na Fishermen's Pier pa 06:45. Nos ta spera bo ku hopi gusto na bordo.",
    "items_plural": {
        "adult": "Adulto",
        "child_4_12": "Mucha (4–12 aña)",
        "infant_0_3": "Mucha (0–3 aña)"
    ...
    "pt": {
    "tagline": "Um dia em Klein Curaçao",
    "party": "{adults} adultos, {children} crianças de 4-12, {infants} crianças de 0-3",
    "catalog": "Catálogo",
    "items": {
        "adult": "Adulto",
        "child_4_12": "Criança (4–12 anos)",
        "infant_0_3": "Criança (0–3 anos)"
    },
    "included_items": [
        "Café da manhã e almoço com churrasco",
        "Refrigerantes e sucos de frutas",
        "Máscaras de snorkel e cadeiras de praia",
        "Casa de praia com banheiros e ducha de água doce"
    ],
    "bring_items": [
        "Toalha",
        "Protetor solar",
    ...
    "protocol_title": "Antes do passeio",
    "protocol": "Siga as orientações do capitão e da tripulação e supervisione as crianças. Use os equipamentos de segurança conforme as instruções. Informe com antecedência se tiver necessidades alimentares ou precisar de assistência. A travessia depende das condições do mar; não podemos garantir que verá tartarugas marinhas. Cerveja e vinho são cobrados à parte. Não fornecemos nadadeiras.",
    "closing": "Será um prazer recebê-lo a bordo.",
    "receipt_title": "Recibo de pagamento",
    "booking_code": "Código da reserva",
    "payment_reference": "Referência do pagamento",
    "payment_time": "Hora do pagamento (UTC)",
    "receipt_disclaimer": "",
    "receipt_arrival": "Pedimos que chegue ao Fishermen's Pier às 06:45. Será um prazer recebê-lo a bordo.",
    "items_plural": {
        "adult": "Adultos",
        "child_4_12": "Crianças (4–12 anos)",
        "infant_0_3": "Crianças (0–3 anos)"
    }
},
}
...
def render_receipt_pdf(reservation: dict, payment: dict, target: Path) -> str:
    ...
    story = [
        _hero(174, 48), Spacer(1, 3 * mm), header, Spacer(1, 4 * mm),
