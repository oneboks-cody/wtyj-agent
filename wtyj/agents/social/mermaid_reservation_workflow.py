...
COPY = {
    ...
    "nl": {
        "intro": "Welkom, ik ben TRACY, Mermaid’s virtuele reserveringsassistent. Ik regel uw trip en maak de volledige offerte hier in WhatsApp.",
        "trip_date": "Op welke datum wilt u Klein Curaçao bezoeken?",
        "adults": "Met hoeveel volwassenen reist u?",
        ...
        "pickup": "Komt u naar Fishermen’s Pier of wilt u hoteltransfer aanvragen?",
        ...
        "confirmed": "Perfect, ik heb uw gegevens bevestigd. Ik maak nu uw reservering en offerte.",
        "cancelled": "Uw reserveringsaanvraag is geannuleerd. Er is niets betaald.",
        "human": "Ik heb dit ter beoordeling aan Mermaid’s team doorgegeven. Uw gegevens zijn opgeslagen en ik kan algemene vragen over de trip blijven beantwoorden.",
    ...
    "es": {
        "intro": "Hola, soy TRACY, la asistente virtual de reservas de Mermaid. Organizaré su paseo y prepararé la cotización completa aquí en WhatsApp.",
        "trip_date": "¿En qué fecha desea visitar Klein Curaçao?",
        "adults": "¿Cuántos adultos viajan?",
        "children": "¿Cuántos niños de 4 a 12 años viajan? Responda 0 si no hay.",
        "infants": "¿Cuántos niños de 0 a 3 años viajan? Responda 0 si no hay.",
        ...
        "confirm": "Responda *SÍ* si todo está correcto o dígame exactamente qué debo cambiar.",
        "confirmed": "Perfecto, sus datos están confirmados. Ahora preparo su reserva y cotización.",
        "cancelled": "Su solicitud de reserva está cancelada. No se realizó ningún pago.",
        "human": "He pasado esto al equipo de Mermaid para que lo revise. Sus datos están guardados y puedo seguir respondiendo preguntas generales sobre la excursión.",
        "invalid_day": "Según la información publicada, Mermaid opera lunes, martes, miércoles, viernes, sábado y domingo. Elija uno de esos días.",
    },
    "pap": {
    ...
    "pt": {
        ...
        "trip_date": "Em que data deseja visitar Klein Curaçao?",
        ...
        "pickup": "Prefere ir ao Fishermen’s Pier ou solicitar traslado do hotel?",
...
WELCOME_COPY = {
    ...
    "es": "¡Hola! Le doy la bienvenida a Mermaid. Soy TRACY, la asistente virtual de reservas de Mermaid.",
...
FAQ_COPY = {
    ...
    "es": {"price": "Adulto USD {adult}; niño de 4-12 USD {child}; 0-3 años gratis. El total detallado estará en la cotización.", "included": "Incluye desayuno, refrescos y jugos, almuerzo BBQ, casa de playa, instalaciones, máscaras de snorkel y sillas de playa.", "bring": "Traiga toallas, protector solar y traje de baño. Mermaid se encarga de la comida, bebidas e instalaciones incluidas."},
...
PAYMENT_COPY = {
    ...
    "nl": ("", "Rond uw boeking hier af:"),
    "de": ("", "Schließen Sie Ihre Buchung hier ab:"),
    "es": ("", "Complete su reserva aquí:"),
